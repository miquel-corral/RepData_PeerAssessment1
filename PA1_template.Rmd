...
The **mean** of the total number of steps taken per day is `r mean_steps_taken_daily`.  
The **median** of the total number of steps taken per day is `r median_steps_taken_daily`.
...
The 5-minutes interval witx maximum number of steps, on average accross all the days in the dataset is `r max.interval[1,1]` and the number of steps on average accross all the days for this interval is `r max.interval[1,2]`.  
...
The **mean** of the total number of steps taken per day is `r mean_steps_taken_daily_no_na`.  
The **median** of the total number of steps taken per day is `r median_steps_taken_daily_no_na`.
